        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-[var(--gap)] items-center">
          ...
          <div>
            ...
            <div className="mt-8 border-t border-[#6B4841]/15 pt-6">
              ...
              <Link
                href="/contact"
                className={`brygada mt-5 inline-flex h-[45px] lg:h-11 items-center justify-center bg-[#6B4841] px-6 text-[1.15rem] font-bold lowercase tracking-[0.18em] text-[#F7EAD8] transition-colors duration-300 hover:bg-[#1E0F0B] ${focusRing}`}
              >
                Contact Us
              </Link>
            </div>
