    ...
    <footer className="bg-[#1E0F0B] text-[#F7EAD8]">
      <div className="max-w-7xl mx-auto px-[var(--gutter)] pt-[var(--section-sm)] pb-[clamp(1.5rem,2.5vw,2.5rem)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-[var(--gap)] items-start mb-14">
          ...
          <div className="flex flex-col sm:flex-row gap-8">
            <nav className="flex flex-col gap-2.5">
              <p className="brygada font-bold text-[length:var(--text-eyebrow)] tracking-[0.3em] uppercase text-[#D49C84] mb-1">Navigate</p>
              {[
                { href: "/", label: "Home" },
            ...
            <nav className="flex flex-col gap-2.5">
              <p className="brygada font-bold text-[length:var(--text-eyebrow)] tracking-[0.3em] uppercase text-[#D49C84] mb-1">Services</p>
          ...
          <div className="flex flex-col gap-2.5 md:items-end md:text-right">
            <p className="brygada font-bold text-[length:var(--text-eyebrow)] tracking-[0.3em] uppercase text-[#D49C84] mb-1">Get in Touch</p>
            <Link
              href="/contact"
        ...
        <div className="border-t border-[#F7EAD8]/10 pt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <p className="text-[length:var(--text-eyebrow)] text-[#F7EAD8]/25 tracking-wider uppercase">
