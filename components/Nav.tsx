    ...
    <>
      ...
      >
        ...
        >
          ...
          <Link
            href="/services"
            className={`brygada hidden h-[var(--nav-btn-h)] shrink-0 items-center whitespace-nowrap ${hero ? "2xl:inline-flex" : "lg:inline-flex"} border-[1.5px] px-[var(--nav-btn-px)] text-[length:var(--nav-btn-text)] font-bold tracking-[0.22em] transition-colors duration-300 ${focusRing} ${
              hero
