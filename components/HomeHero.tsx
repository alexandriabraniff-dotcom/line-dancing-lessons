...
export default function HomeHero() {
  return (
    ...
    >
      ...
      <div className="relative row-start-2 mx-[var(--hero-gutter)] mt-[calc(var(--hero-gutter)-var(--hero-pad-top)-2.75rem)] min-h-[calc(50svh-var(--hero-gutter))] overflow-hidden rounded-t-[calc((100vw-2*var(--hero-gutter))*0.225)] lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:mx-0 lg:mt-0 lg:h-auto lg:rounded-none">
        <Image
          src="/hero-crowd.jpg"
