...
export default function HomeHero() {
  return (
    ...
    >
      ...
      {/* Copy */}
      <div className="relative z-10 row-start-3 flex flex-col items-center justify-center px-[var(--hero-gutter)] pt-[var(--hero-gap-lg)] pb-[var(--hero-gap-lg)] lg:row-start-2 lg:py-[max(1.5rem,4vh)] text-center lg:col-start-1 lg:items-start lg:text-left">
        <h1
          id="hero-heading"
