...
const contactFields: BookingField[] = [
  ...
  { name: "phone", label: "Phone Number", type: "tel", placeholder: "(604) 555-0123" },
];
...
export const bookingServices: BookingService[] = [
  {
    ...
    fields: [
      ...
      { name: "location", label: "Venue or City", type: "text", placeholder: "e.g. Vancouver" },
      {
        name: "guests",
  ...
  },
  {
    ...
    fields: [
      ...contactFields,
      { name: "date", label: "Party Date", type: "date" },
      { name: "location", label: "Venue or City", type: "text", placeholder: "e.g. Burnaby" },
      {
        name: "guests",
        label: "Number of Guests",
        type: "select",
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "organization", label: "Company or Organization", type: "text", placeholder: "Optional" },
      { name: "date", label: "Event Date", type: "date" },
      { name: "location", label: "Venue or City", type: "text", placeholder: "e.g. Richmond" },
      {
        name: "guests",
        label: "Group Size",
        type: "select",
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "location", label: "Preferred Location", type: "text", placeholder: "Your home, studio, office..." },
      {
        name: "guests",
        label: "Group Size",
        type: "select",
